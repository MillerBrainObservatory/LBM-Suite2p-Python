# Cellpose Integration: Suite2p vs Direct

This document explains the differences between running Cellpose through Suite2p's `anatomical_only` mode versus using `lsp.cellpose()` directly.
...
The following figures (generated by `demos/notebooks/cellpose_figure_generation.ipynb`) show the effect of each preprocessing step:

### Temporal Binning Effect
![Temporal Binning Comparison](_images/cellpose_binning_comparison.png)

### High-Pass Filter Effect
![High-Pass Filter Comparison](_images/cellpose_hp_comparison.png)

### Anatomical Mode Comparison
![Anatomical Mode Comparison](_images/cellpose_mode_comparison.png)
